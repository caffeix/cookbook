...
| 3 | 13-08-25 | `/app/seed.py`: Decision made a while ago but not documented; the data management is done entirely via seeding, since the admin console is postponed til v2. |